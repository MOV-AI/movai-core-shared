...
from logging import DEBUG, NOTSET, WARNING, INFO
...
MOVAI_HEALTHNODE_VERBOSITY_LEVEL = os.getenv("MOVAI_HEALTHNODE_VERBOSITY_LEVEL", INFO)
...
REST_SCOPES = "(Callback|Form|Flow|Node|GraphicScene|Package|StateMachine|Layout|Annotation|Application|Configuration|SharedDataTemplate|SharedDataEntry|TaskTemplate|TaskEntry)"
SCOPES_TO_TRACK = [
    'Node',
    'Callback',
    'Flow',

...
MESSAGE_SERVER_INTERNAL_PORT = int(os.getenv("MESSAGE_SERVER_INTERNAL_PORT", "9001"))
MESSAGE_SERVER_PORT = int(os.getenv("MESSAGE_SERVER_PORT", "9000"))
MESSAGE_SERVER_INTERNAL_BIND_ADDR = f"tcp://{MESSAGE_SERVER_BIND_IP}:{MESSAGE_SERVER_INTERNAL_PORT}"
MESSAGE_SERVER_EXTERNAL_BIND_ADDR = f"tcp://{MESSAGE_SERVER_BIND_IP}:{MESSAGE_SERVER_PORT}"

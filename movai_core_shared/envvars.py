...
MESSAGE_SERVER_PORT = os.getenv("MESSAGE_SERVER_PORT", 8081)
MESSAGE_SERVER_BIND_ADDR = os.getenv("MESSAGE_SERVER_BIND_ADDR", f"tcp://{MESSAGE_SERVER_BIND_IP}:{MESSAGE_SERVER_PORT}")

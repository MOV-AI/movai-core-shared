...
BACKEND_SERVER_BIND_IP = os.getenv("BACKEND_SERVER_BIND_IP", "0.0.0.0")
BACKEND_SERVER_PORT = os.getenv("BACKEND_SERVER_PORT", "9000")
BACKEND_SERVER_BIND_ADDR = f"tcp://{BACKEND_SERVER_BIND_IP}:{BACKEND_SERVER_PORT}"

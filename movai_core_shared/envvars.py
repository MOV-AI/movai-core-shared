...
import os
from logging import NOTSET, INFO, DEBUG, WARNING
import socket
from .consts import (
    MESSAGE_SERVER_HOST,
    ADMIN_ROLE,
...
MOVAI_FLEET_LOGS_VERBOSITY_LEVEL = int(os.getenv("MOVAI_FLEET_LOGS_VERBOSITY_LEVEL", str(DEBUG))) # Verbosity level for influxdb logs
...
MOVAI_GENERAL_VERBOSITY_LEVEL = int(os.getenv("MOVAI_GENERAL_VERBOSITY_LEVEL", str(INFO))) # Verbosity level for spawner logs
MOVAI_CALLBACK_VERBOSITY_LEVEL = int(os.getenv("MOVAI_CALLBACK_VERBOSITY_LEVEL", str(DEBUG))) # Verbosity level for callback logs

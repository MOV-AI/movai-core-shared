...
NODE_TYPE = [ROS1_NODELET, ROS1_NODE, ROS1_PLUGIN, MOVAI_NODE,
             MOVAI_STATE, MOVAI_SERVER, ROS2_NODE, ROS2_LIFECYCLENODE]
...
PORTS_TEMPLATE = [MOVAI_INIT, MOVAI_TRANSITIONFOR, MOVAI_TRANSITIONTO, MOVAI_DEPENDS,
                  MOVAI_DEPENDENCY, ROS1_NODELETCLIENT, ROS1_NODELETSERVER, MOVAI_WIDGET,
                  REDIS_SUBSCRIBER, ROS1_TIMER, ROS1_RECONFIGURECLIENT,
                  ROS1_SERVICECLIENT, ROS1_ACTIONSERVER, ROS1_ACTIONCLIENT,
                  ROS1_SUBSCRIBER, ROS1_TFPUBLISHER, ROS1_SERVICESERVER,
                  ROS1_PUBLISHER, ROS1_TFSUBSCRIBER, FLASK_HTTPENDPOINT,
                  HTTP_ENDPOINT, HTTP_SOCKETIO]

...
REDIS_PORT_TEMPLATES = [REDIS_SUBSCRIBER]
ROS1_PORT_TEMPLATES = [
    ROS1_TIMER,
...
ROS2_PORT_TEMPLATES = [ROS2_SUBSCRIBER, ROS2_PUBLISHER, ROS2_SERVICECLIENT, ROS2_SERVICESERVER]
FLASK_PORT_TEMPLATES = [FLASK_HTTPENDPOINT]
HTTP_PORT_TEMPLATES = [HTTP_ENDPOINT, HTTP_SOCKETIO]

# all ports templates
PORT_TEMPLATES = (
    MOVAI_PORT_TEMPLATES
    + REDIS_PORT_TEMPLATES
    + ROS1_PORT_TEMPLATES
    + ROS2_PORT_TEMPLATES
    + FLASK_PORT_TEMPLATES
    + HTTP_PORT_TEMPLATES
)
